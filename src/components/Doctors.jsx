...
const Doctors = () => {
  ...
  return (
    <div className="flex flex-col justify-center min-h-screen px-5 pt-16 lg:px-32">
      <motion.div
        initial={{ opacity: 0, y: -20 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.7 }}
        viewport={{ once: true }}
        className="flex flex-col items-center justify-between mb-10 lg:flex-row lg:mb-0"
      >
        <div>
          ...
          {data.map((e, index) => (
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center">
                <h1 className="pt-4 text-xl font-semibold">{e.name}</h1>
